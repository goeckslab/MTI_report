...
def get_args():
    ...
    nargs = "+",
    help = "list of resolutions to test (default is just [0.5,0.6])", 
    required = False,
    default = [0.5,0.6])
...
def main():
    ...
    compositional.sample_compositional_plots(adata)
    ...
    markdown.markdownFromFile(input = os.path.join(os.getcwd(),'template.md'), output = f'{bname}_report.html')

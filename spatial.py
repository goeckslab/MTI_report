...
def plot_spatial(adata, columns = ['phenotype', 'region']): # need cols as an argument
    ...
    sq.gr.interaction_matrix(adata, cluster_key="phenotype", normalized=True)
    sq.gr.ripley(adata, 'phenotype', mode = 'L')

    sq.pl.interaction_matrix(adata, cluster_key="phenotype", title = "Phenotype interaction matrix",
    annotate = True, dpi = 500, figsize=(10,10), save = "spatial_interaction.png")

    sq.pl.ripley(adata, cluster_key='phenotype',
    mode='L', dpi = 500, figsize=(10,10), save = "ripley_L.png")
